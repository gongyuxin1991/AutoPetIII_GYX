...
class Autopet_baseline:
    ...
    def __init__(self):
        ...
        self.nii_path = (
            "/opt/algorithm/nnUNet_raw/Dataset131_Autopet3/imagesVa"
        )
        self.result_path = (
            "/opt/algorithm/nnUNet_raw/Dataset131_Autopet3/imagesVa/result"
        )
    ...
    def load_inputs(self):
        ...
        self.convert_mha_to_nii(
            ...
            os.path.join(self.nii_path, "Autopet_131_0000.nii.gz"),
        )
        self.convert_mha_to_nii(
            os.path.join(self.input_path, "images/pet/", pet_mha),
            os.path.join(self.nii_path, "Autopet_131_0001.nii.gz"),
        )
        return uuid
    ...
    def predict(self):
        ...
        cproc = subprocess.run(
           f"nnUNetv2_predict -i {self.nii_path} -o {self.result_path} -d 131 -c 3d_fullres_resenc_bs9 -f 0 -step_size 0.6 --disable_tta",
